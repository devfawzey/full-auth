...
const register = async (req, res) => {
 ...
 // and now all clear and user craeted || @next step verify the email
...
const verifyEmail = async (req, res) => {
 ...
 // i want to tell user that otp has been sent

 // if both of them not there send error required fields
 if (!email || !otp) {
...
const resetPassword = async (req, res) => {
 // const { email, token: resetPassordToken } = req.query
 ...
 // user exist is user email verified? he cant verified it !! user must be verifieded
 // valid this otp
